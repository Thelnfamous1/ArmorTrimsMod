...
/**
 * the original is hardcoded to TamableAnimal
 */
public class CustomFollowOwnerGoal extends Goal{
    ...
    public CustomFollowOwnerGoal(Mob pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
    ...
    public boolean canUse() {
        LivingEntity livingentity = ((OwnableEntity)this.tamable).getOwner();
