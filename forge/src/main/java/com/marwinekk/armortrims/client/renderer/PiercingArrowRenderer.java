...
public class PiercingArrowRenderer extends EntityRenderer<PiercingArrowEntity> {
	...
	@Override
	public void render(PiercingArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(PiercingArrowEntity entity) {
		return texture;
	}
}
