...
public class Pa2Renderer extends EntityRenderer<Pa2Entity> {
	...
	public Pa2Renderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelhigharrow_java(context.bakeLayer(Modelhigharrow_java.LAYER_LOCATION));
	}

	@Override
	public void render(Pa2Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(Pa2Entity entity) {
		return texture;
	}
}
